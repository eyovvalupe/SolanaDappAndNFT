import { Keypair, Cluster, Connection, PublicKey, TransactionInstruction, AddressLookupTableAccount } from '@solana/web3.js';
...
declare const confirmTransaction: (connection: Connection, signature: string) => Promise<string>;
...
export { InitializeKeypairOptions, addKeypairToEnvFile, airdropIfRequired, confirmTransaction, getCustomErrorMessage, getExplorerLink, getKeypairFromEnvironment, getKeypairFromFile, getLogs, getSimulationComputeUnits, initializeKeypair, keypairToSecretKeyJSON, makeKeypairs };
